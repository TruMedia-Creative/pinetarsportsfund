...
export function useHomepageImmersiveScroll(stageRef: Ref<HTMLElement | null>) {
  ...
  onMounted(async () => {
    ...
    const scenes = Array.from(stage.querySelectorAll<HTMLElement>('[data-home-scene]'))
    ...
    const context = gsap.context(() => {
      ...
      media.add('(min-width: 1024px)', () => {
        const atmosphere = stage.querySelector<HTMLElement>('.homepage-immersive-atmosphere')
        const orbits = Array.from(stage.querySelectorAll<HTMLElement>('[data-home-orbit]'))
