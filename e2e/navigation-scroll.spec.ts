...
test('about navigation returns to the landing page and targets the about section from investments', async ({
  page,
}) => {
...
test('home page renders the new narrative sections and how-it-works steps in order', async ({
  ...
  await expect(page.locator('#mechanism p').first()).toHaveText(
    'Every opportunity is reviewed through the lens of:'
  );
